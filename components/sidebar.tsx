...
import { LayoutDashboard, Database, Code2, History, BarChart3 } from 'lucide-react';
  ...
  return (
    <div className="w-64 bg-gradient-to-b from-slate-900 to-slate-950 border-r border-slate-700 h-screen flex flex-col sticky top-0">
      ...
      <nav className="flex-1 p-4">
        <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">MENÚ</p>
